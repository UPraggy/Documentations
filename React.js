...
/*O useState é utilizado para criar variaveis que podem ser modificadas,
e apresentadas na pagina, em sua declaração é usada duas variaveis,
uma que é a propria e outra para armazenar a função que vai modificar o estado/valor
da primeira.
Exemplo de declaração: */

/*
Neste exemplo foi criada um componente que apresenta a hora atual,
foi utilizada a função setInterval para atualizar o relogio a cada
segundo, foi colocado o IF para evitar o bug de tentar setar o valor
antes da variavel ser inicializada.

Além disso foi colocado outros exemplos de declaração.
*/
...
/*
Neste exemplo é apresentado também, como lidar com eventos,
nesse caso foi usado o evento onChange do input,
os eventos tem que ser escritos com a segunda palavra
com a letra inicial maiscula
*/
...
/*
UseEffect é chamado sempre que a pagina é atualizada/carregada,
excelente para utilizar para criar e executar funções, assim
que a pagina é atualizada, além disso tira a necessidade do if
verificando se a variavel é inicializada (exemplo no MODULO USESTATE)*/
...
/*
Não esqueça, que useEffect só é chamado,
quando a pagina é totalmente carregada,
ou seja ele tem um delay	
*/
...
/*
Pode Haver necessidade de passar um mesmo valor entre varios,
arquivos e uma das formas de fazer isso é utilizando
variaveis globais, vale mencionar, que as variaveis
podem ser alteradas porém não são renderizadas
como as que utilizam useState, elas são semelhantes ao 'props',
porém há formas de contornar isso
...
/*
Neste modulo sera mostrado como mudar de pagina,
basicamente a troca sera dada por condições,
onde vai ser renderizado ou não um componente,
e poderá ser colocada a url, ao realizar isso
é possível ir e voltar entre paginas, armazenando historico
